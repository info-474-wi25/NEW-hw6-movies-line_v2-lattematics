...
d3.csv("movies.csv").then(data => {
    ...
    // not sure what this part is, i don't see it in the video demo or the slide
    // i'm assuming that this part is optional since it doesn't seem to contribute visually to the end result
